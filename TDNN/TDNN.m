...
%batch_sz = 44100;
batch_sz = 44100*5;
no_epochs = 15; %número de interaciones de entrenamiento (epochs)
no_cycles = 1; 
...
switch signal_type
    case "deterministic"
        ...
        %playlist = ["AM", "FM"];
        %playlist = "sine_1000";
        playlist =["sine_10000", "sine_2500", "sine_1000"];
    case "track"
        path = main_path + "clips musicales\";
        %playlist = "atlantic_limited";
        %playlist = ["lonely_cat", "karma_police", "blauen_donau", "bohemian_rhapsody", "cadence", "peru", "week_no_8"];
        %playlist = ["bohemian_rhapsody", "cadence", "peru", "week_no_8"];
        %playlist = ["atlantic_limited", "lonely_cat", "karma_police", "blauen_donau"];        
        %playlist = ["bohemian_rhapsody", "peru"];
        playlist = "peru";
        %playlist = ["week_no_8", "peru"];
end
