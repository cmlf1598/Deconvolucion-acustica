function [features_ext] = feature_extractor(fs, X)
    ...
    afe = audioFeatureExtractor("SampleRate",fs, ...
        ...
        "spectralFlux", true, ...           %qué tanto variías el espectro (alto flujo espectral en una pista de batería).
    ...
    idx = info(afe);
    duration = size(X,1)/fs;
    
    %Ejes temporales
    t_X = linspace(0,duration,size(X,1));    
