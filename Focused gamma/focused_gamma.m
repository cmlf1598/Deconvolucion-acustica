...
train_network = false; %si se desea entrenar la red
...
epsilon = (5e3)*beta; %tasa de aprendizaje de mu
mu_initial = 0.75;
batch_sz = 4410;  
...
activation_func = activation_functions(a); %función de activación
    ...
    for c = 1:no_cycles
        ...
        for n = 1:no_tracks
            ...
            if save_numerical == true
                ...
                %mu promedio
                mean_mu = mean(mu);
                save(char("results\"+activation_func+"\"+"numerical\"+"mean_mu_"+activation_func+"_"+playlist(n)+".mat"),'mean_mu');
    ...
    if ((training == "full_playlist_net") && (train_network == true))
        ...
        xlabel('Batch'); 
        ylabel('Cost');
        saveas(figure(4), [pwd char("\results\"+activation_func+"\"+"general_cost_"+"_gamma_"+activation_func+".eps")] );
        saveas(figure(4), [pwd char("\results\"+activation_func+"\"+"png\"+"general_cost_"+"_gamma_"+activation_func+".png")] );
